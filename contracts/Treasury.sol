...
contract Treasury is Ownable,IERC721Receiver{
    using SafeMath for uint;

    IERC721 public nftAddress;
    IERC20 public tokenAddress;
    mapping(address => uint[]) public usersTokens;
    mapping(address => uint256) public userDepoistedTokens;
    ...
    function depositEth(uint256 amount) public payable {
        ...
        userDepositedEth[msg.sender] = userDepositedEth[msg.sender].add(msg.value);
    }
    ...
    function depositToken(uint amount) public {
        ...
        userDepoistedTokens[msg.sender] = userDepoistedTokens[msg.sender].add(amount);
    }

    function withdrawNFT(uint tokenId) public onlyOwner {
